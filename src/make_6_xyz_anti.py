...
def make_xyzfile(monomer_name,params_dict):
    ...
    monomer_array_t1 = get_monomer_xyza(monomer_name,a_/2,b_/2,0,A2+180,-A3)
    monomer_array_t2 = get_monomer_xyza(monomer_name,a_/2,-b_/2,0,A2+180,-A3)
    monomer_array_t3 = get_monomer_xyza(monomer_name,-a_/2,-b_/2,0,A2+180,-A3)
    monomer_array_t4 = get_monomer_xyza(monomer_name,-a_/2,b_/2,0,A2+180,-A3)
    xyz_list=['400 \n','polyacene9 \n']##4分子のxyzファイルを作成
